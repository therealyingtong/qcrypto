...
/* timeout stuff */
struct timeval timout; /* default timeout  */
...
int main(int argc, char *argv[]){
    ...
    int cnt=0;    struct termios myterm;
    ...
    //myterm.c_cc[VTIME] =0; myterm.c_cc[VMIN]=0;
    ...
    for(;;) {
	/* set timeout */
	timout.tv_sec=READ_TIMEOUT / 1000;
	timout.tv_usec=(READ_TIMEOUT % 1000)*1000;
	FD_ZERO(&fds);
